...
//2 Config Flags and Structs - defined by each ODM Type
	...
	// Flags
	#include "8192cd_cfg.h"			// ADSL config flags.
	#include "odm_inc.h"			// some extra flags.
	// Data Structure
	#include "common_types.h"	// rtl8192cd needs basic type such as UINT8 and BIT0.
	#include "8192cd.h"			// basic ADSL struct definition.
	#include "8192cd_util.h"		// basic I/O function.
	#ifdef _BIG_ENDIAN_
	#define	ODM_ENDIAN_TYPE				ODM_ENDIAN_BIG
	#else
	#define	ODM_ENDIAN_TYPE				ODM_ENDIAN_LITTLE
